...
export function websiteJsonLd(): object {
	return {
		...
		url: SITE_URL,
		description: 'Daily answers and explanations for LinkedIn Pinpoint word puzzle game. Updated daily with accurate solutions, detailed explanations, and a complete puzzle archive.',
		inLanguage: 'en-US',
		potentialAction: {
			'@type': 'SearchAction',
			target: {
...
export function organizationJsonLd(): object {
	return {
		...
		description: 'Independent resource providing daily verified answers, detailed explanations, and a complete archive for the LinkedIn Pinpoint word puzzle game.',
		foundingDate: '2025',
		sameAs: [],
		contactPoint: {
			'@type': 'ContactPoint',
...
export function authorJsonLd(): object {
	return {
		...
		description: 'Daily players and analysts of LinkedIn Pinpoint who verify every answer and write detailed clue-by-clue explanations.',
		url: `${SITE_URL}/about`
	};
}
...
export function reviewerJsonLd(): object {
	return {
		...
		description: 'Verification team that cross-checks every published answer against the official LinkedIn Pinpoint game before publication.'
	};
}
...
export function howToJsonLd(): object {
	return {
		...
		description: 'Step-by-step guide to solving LinkedIn Pinpoint daily word puzzles faster and more accurately.',
		totalTime: 'PT3M',
		author: {
			'@type': 'Person',
			name: 'Pinpoint Answer Today Editorial Team',
